...
after_get_config = django.dispatch.Signal(providing_args=["config"])
...
before_authenticated = django.dispatch.Signal(providing_args=["request", "user"])
after_authenticated = django.dispatch.Signal(providing_args=["response"])
